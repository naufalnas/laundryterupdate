...
@section('judul')
<h1>Ini Halaman Detail/Show Paket</h1>
@endsection
     ...
     <form action="/paket" method="POST">
       ...
       <div class="card-body">
         ...
         <label for="inputoutletid">Id Outlet</label>
            <input type="integer" name="outlets_id" class="form-control" id="inputoutletid" placeholder="Enter Id Outlet" value="{{ $paket->outlets_id }}" disabled  >
              </div>
          <div class="form-group">
          <label>Jenis</label>
       ...
       <a class="btn btn-primary" href="/paket">Back</a>
       </div>
     </form>
 </div>
@endsection