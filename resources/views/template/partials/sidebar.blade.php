<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ asset('adminlte/index3.html')}}" class="brand-link">
      <img src="{{asset('adminlte/dist/img/dicuciin.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">DiCUCiiN</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('adminlte/dist/img/udahfix.jpg')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
